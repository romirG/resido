...
function AnalyticsOverview() {
    ...
    const properties = [
        { title: '3 BHK Apartment, Koramangala', views: 2340, inquiries: 28, status: 'Below Market', statusColor: 'green' },
        { title: '2 BHK Flat, Indiranagar', views: 1850, inquiries: 15, status: 'At Market', statusColor: 'yellow' },
        { title: '4 BHK Villa, Whitefield', views: 890, inquiries: 8, status: 'Above Market', statusColor: 'red' }
    ];

...
function LuxuryBrowseProperties({ onViewProperty, onNavigate, initialFilters = '' }) {
    ...
    const CITIES = ['Bangalore', 'Delhi', 'Mumbai', 'Pune', 'Hyderabad', 'Chennai'];
        ...
        <div className="luxury-browse">
            ...
            <nav className="luxury-browse__nav">
                ...
                <div className="luxury-browse__nav-actions">
                    ...
                    <button className="nav-icon-btn" onClick={() => onNavigate('messages')} title="Messages">
                        <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <div className="luxury-filter-panel__content">
                    ...
                    <div className="filter-section">
                        ...
                        <div className="price-range">
                            ...
                            />
                            <span className="price-value">Up to {formatPrice(filters.max_price)}</span>
                        </div>
                    </div>
                    ...
                    <div className="filter-actions">
                        <button className="btn-filter-clear" onClick={clearFilters}>Clear All</button>
